...
const PvPCommand_2 = require("../pvp_score/PvPCommand");
var Trigger;
(function (Trigger) {
...
class GameFSM {
    ...
    OnShoot(client, message) {
        let enemyId = message.enemyId;
        let damage = message.damage;
        this.dispatcher.dispatch(new PvPCommand_1.ShootCommand(), { enemyId: enemyId, damage: damage });
    }
    sendScore(client, message) {
        let score = message.score;
        this.dispatcher.dispatch(new PvPCommand_2.SendScoreRoomCommand(), { sessionId: client.sessionId, score: score });
    }
